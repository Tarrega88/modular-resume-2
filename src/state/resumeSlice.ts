    ...
    reducers: {
        ...
        copyResume(state, action: PayloadAction<{ originalId: string; newId: string; }>) {
            ...
            state.resumeMetaData[newId] = {
                resumeName: newName, resumeId: newId, createdAt: now, margin, font, pageStyle, fontScale
            }
        ...
        generateMetaData(state, action: PayloadAction<string>) {
            ...
            state.resumeMetaData[action.payload] = {
                resumeName: "", resumeId: action.payload, createdAt: formatDate(now), margin: 75, font: "Noto Sans", pageStyle: "Letter", fontScale: 1
            }
        },
