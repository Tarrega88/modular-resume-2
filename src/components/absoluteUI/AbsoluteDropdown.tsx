...
function AbsoluteDropdown({
  ...
  const height = isMaximized ? "h-90" : "h-38";
  ...
  return (
    <div
      ...
      className="text-base sticky top-0 -translate-y-8 z-40 w-full"
    >
      <div className="w-[754px] ml-[48px] bg-slate-800 overflow-scroll p-1 rounded-sm absolute">
